...
import {createLoanSchema, findLoanByIdSchema, updateLoanSchema} from "./loan.validator";
...
loanRouter.get("/:id", authorizeRoles("MANAGER", "ADMIN"), validate(findLoanByIdSchema), loanController.getLoanById)
...
loanRouter.delete("/:id", authorizeRoles("MANAGER", "ADMIN"), validate(findLoanByIdSchema), loanController.deleteLoan)

loanRouter.put("/:id/returnBook", authorizeRoles("ADMIN", "MANAGER"), validate(findLoanByIdSchema), loanController.returnBook)
